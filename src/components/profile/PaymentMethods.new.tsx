import React, { useState, useEffect, useCallback } from '../../../node_modules/@types/react';
import { 
  View, 
  Text, 
  StyleSheet, 
...
import type { ProfileStackParamList } from '../../navigation/ClientNavigator';
...
const PaymentMethods: React.FC<PaymentMethodsScreenProps> = ({ navigation, route }) => {
